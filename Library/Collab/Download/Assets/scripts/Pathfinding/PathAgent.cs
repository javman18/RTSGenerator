...
public class PathAgent : MonoBehaviour
{
    ...
    public void Movement()
    {
        ...
        if (path != null)
        {
            ...
            if(Vector3.Distance(transform.position, targerPos) > GetComponent<AgentManager>().mass * (GetComponent<AgentManager>().maxScale * 2))
            {
            ...
            //agent.Flocking();
            //if(transform.position == path[currentIndex - 1])
            //{
